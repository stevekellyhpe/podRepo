Pod::Spec.new do |s|
  s.name         = "MeridianSDK"
  s.version      = "3.5.0"
  s.summary      = "Indoor Location and Wayfinding"
  s.homepage     = "https://meridianapps.com"
  s.license      = {
      :type => 'Commercial',
      :text => <<-LICENSE
  ...
  s.platform     = :ios, '8.0'
  s.source       = { :http => "http://files.meridianapps.com/meridian-ios-sdk/meridian-ios-sdk-only-#{s.version}.zip" }
